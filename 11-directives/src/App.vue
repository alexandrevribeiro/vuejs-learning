    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <h1>Custom Directives (global)</h1>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <h1>Custom Directives (local)</h1>
                <p v-local-highlight="'red'">Color this! (text)</p>
                <p v-local-highlight:background.delayed.blink="'red'">Color this! (background)</p>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        directives: {
            'local-highlight': HighlightDirective
        }
    }
</script>
